...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(121, 220);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(229, 220);
			...
			this->linkLabel1->Location = System::Drawing::Point(56, 71);
